...
export function buildTransactionPrompt(
  ...
  return (
    ...
    '   - JANGAN PERNAH membuat transaksi terpisah untuk: Biaya Layanan, Biaya Pengiriman, Biaya Tambahan Resto, Biaya Resto, Biaya Admin, Ongkos Kirim, Ongkir, Biaya Platform, Biaya Kemasan/Bungkus/Plastik, Biaya Penanganan, Biaya Aplikasi, Biaya Asuransi, Biaya Proteksi Keamanan, PPN, Pajak, Driver Tip, atau biaya tambahan lainnya yang merupakan bagian dari satu pesanan e-commerce/food delivery. Semua biaya ini sudah TERMASUK dalam satu Grand Total.\n' +
    '   - "note" diisi dengan nama barang/menu utama yang dipesan (bukan nama platform-nya, dan bukan nama biayanya). Contoh: "Triple Cheese Flatzz" (bukan "Shopee Food"). Jika ada banyak item, sebutkan yang paling dominan atau ringkas jadi "[item utama] dan lainnya".\n' +
    ...
    '   - Contoh: screenshot Shopee Food dengan menu "Triple Cheese Flatzz" subtotal Rp27.000 + biaya pengiriman Rp1.000 + biaya layanan Rp4.500 + biaya tambahan resto Rp3.000 = total Rp35.500 → WAJIB SATU transaksi: amount=35500, note="Triple Cheese Flatzz", category="Makan", wallet="Bank/E-walet". JANGAN PERNAH dipecah menjadi 4 transaksi terpisah!\n\n' +
    ...
    '   - "date": WAJIB deteksi dulu apakah ada referensi waktu di teks, baru default ke hari ini (' + todayStr + ') kalau BENAR-BENAR tidak ada kata/frasa waktu apapun disebutkan. Aturan konversi relatif ke hari ini (' + todayStr + '): "kemarin"/"kemaren" = -1 hari; "kemarin lusa" = -2 hari; "N hari (yang) lalu" = -N hari; "seminggu lalu"/"minggu lalu" = -7 hari; "besok" = +1 hari (untuk pencatatan rencana/utang); "tadi pagi/siang/sore/malam", "barusan", "hari ini" = tetap hari ini (0). Nama hari (mis. "senin kemarin", "hari senin") = tanggal hari itu yang paling baru SEBELUM atau SAMA DENGAN hari ini. Tanggal eksplisit (mis. "tanggal 20", "20 agustus") = tanggal tsb, asumsikan bulan/tahun berjalan kalau tidak lengkap, mundurkan ke bulan sebelumnya kalau hasilnya di masa depan. Field "date" WAJIB tetap terisi (YYYY-MM-DD).\n\n' +
