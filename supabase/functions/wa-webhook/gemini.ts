...
export function buildTransactionPrompt(
  ...
  // !! PROMPT INI ADALAH SALINAN VERBATIM DARI index.html#L9011-9086 !!
  // Jangan ubah tanpa mengubah versi di index.html juga.
  return (
